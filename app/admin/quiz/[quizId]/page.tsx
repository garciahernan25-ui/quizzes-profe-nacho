  ...
  return (
    <main style={{ padding: "3rem", maxWidth: "800px", margin: "0 auto" }}>
      ...
      {cargando ? (
        ...
        <p style={{ color: "#555" }}>Este quiz todavía no tiene preguntas.</p>
      ) : (
        <>
          <p style={{ color: "#555", marginBottom: "1.5rem" }}>Total: {preguntas.length} preguntas</p>
            ...
            {preguntas.map((p) => (
              <div key={p.id} style={{
                ...
                <div>
                  ...
                  <div style={{ color: "#888", fontSize: "0.85rem" }}>{p.seccion}</div>
                </div>
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  <a
                    ...
                    style={{
                      ...
                      background: "white", color: "#2563eb", textDecoration: "none", whiteSpace: "nowrap",
                    }}
                  >
                    Editar
                  </a>
